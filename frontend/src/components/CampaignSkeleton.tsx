const CampaignMask = () => {
	return (
		<div className='lg:w-56 xl:w-72 w-full rounded-2xl bg-zinc-800 animate-pulse '>
			<div className='w-full h-52 object-cover rounded-2xl bg-zinc-700/80'></div>
			<div className='flex flex-col p-4'>
				...
				<div className='flex justify-between items-start flex-wrap mt-4 gap-2'>
					<div className='flex flex-col'>
						<div className=' mt-1 rounded-md bg-zinc-700 h-5 w-6'></div>
						<span className='flex gap-2 mt-1 items-center'>
							<div className='rounded-md h-4 bg-zinc-700 w-16'></div>
							<div className='w-6 h-6 bg-zinc-700 rounded-full'></div>
						</span>
					</div>
					<div className='flex flex-col w-1/2 justify-end mt-2'>
						<div className='rounded-md h-4 bg-zinc-700 w-14 self-end'></div>
						<div className='mt-2 h-4 rounded-md bg-zinc-700 w-14 self-end'></div>
					</div>
				</div>
				<div className='flex items-center mt-5 gap-4'>
					...
					<div className='mt-1 h-3 rounded-md bg-zinc-700 w-full'></div>
				</div>
			</div>
		</div>
	)
